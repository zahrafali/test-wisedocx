...
export declare type SectionPropertiesOptions = IPageSizeAttributes & IPageMarginAttributes & IDocGridAttributesProperties & IHeadersOptions & IFootersOptions & IPageNumberTypeAttributes & ILineNumberAttributes & IPageBordersOptions & ITypeAttributes & {
    readonly type?: {
        readonly val?: string;
    };
} & ITitlePageOptions & {
